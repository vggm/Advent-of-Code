...
while not crash_found:
  ...
  for car_idx, (i, j, inter_i, car_dir) in enumerate(cars):
    ...
    if (ni, nj) in car_pos:
      crash_found = True
      cars[car_idx] = ni, nj, new_inter_i, new_car_dir  
      break
